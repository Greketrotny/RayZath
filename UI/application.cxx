...
namespace RayZath::UI
{
	...
	int Application::run()
	{
        ...
        VkResult err = glfwCreateWindowSurface(g_Instance, mp_window, g_Allocator, &surface);
        check_vk_result(err);

        // Create Framebuffers
        int w, h;
        glfwGetFramebufferSize(mp_window, &w, &h);
        ...
        ImGui_ImplGlfw_InitForVulkan(mp_window, true);
